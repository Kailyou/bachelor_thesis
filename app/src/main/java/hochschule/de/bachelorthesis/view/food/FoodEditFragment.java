                        ...
                        new Observer<Integer>() {
                            ...
                            public void onChanged(Integer integer) {
                                ...
                                if (!newFood.equals(food)) {
                                    ...
                                    snackBar(mBinding.foodName.getText().toString() + " updated...");
                                } else {
                                    snackBar("You cannot updateFood the same food!");
                                }
                            }
                        });
            }
